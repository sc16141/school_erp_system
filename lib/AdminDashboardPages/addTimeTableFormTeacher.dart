...
class TeacherTimeTableForm extends StatefulWidget {
  @override
  _TeacherTimeTableFormState createState() => _TeacherTimeTableFormState();
}

class _TeacherTimeTableFormState extends State<TeacherTimeTableForm> {
    ...
    return Form(
      ...
      child: ListView(
        ...
        children: [
          ...
          // Teacher Selection using AppDropdown
          AppDropdown.teacher(
          ...
          // Subject Selection using AppDropdown
          AppDropdown.subject(
          ...
          // Department Selection using AppDropdown
          ...
          // Time Slot Selection using AppDropdown
          AppDropdown.timeSlot(
